// Enable linting with ECMAScript version 6 syntax
// jshint esversion:6
...
async function main() {
  await mongoose.connect('mongodb+srv://AntarikChetia:Antarik123@cluster0.7d4pcim.mongodb.net/todoListDB?retryWrites=true&w=majority');
}
